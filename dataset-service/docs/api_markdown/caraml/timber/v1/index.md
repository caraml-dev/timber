...
- [caraml/timber/v1/observation_service.proto](#caraml_timber_v1_observation_service-proto)
    ...
    - [Source](#caraml-timber-v1-Source)
...
| status | [Status](#caraml-timber-v1-Status) |  | Status of the observation service |
...
| id | [int64](#int64) |  | Observation service id |
| name | [string](#string) |  | Observation service name |
| source | [Source](#caraml-timber-v1-Source) |  | Configuration for pull-based Observation Service data source. |
| status | [Status](#caraml-timber-v1-Status) |  | Status of the observation service |
| create_time | [google.protobuf.Timestamp](#google-protobuf-Timestamp) |  | Creation timestamp |
| update_time | [google.protobuf.Timestamp](#google-protobuf-Timestamp) |  | Last update timestamp |
...
<a name="caraml-timber-v1-Source"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| type | [ObservationServiceDataSourceType](#caraml-timber-v1-ObservationServiceDataSourceType) |  | Data source of the observation service |
