...
type mockConstructorTestingTNewMLPService interface {
	mock.TestingT
	Cleanup(func())
}

// NewMLPService creates a new instance of MLPService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMLPService(t mockConstructorTestingTNewMLPService) *MLPService {
	mock := &MLPService{}
	mock.Mock.Test(t)
