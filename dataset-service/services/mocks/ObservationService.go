...
func (_m *ObservationService) CreateService(projectName string, config *api.ObservationServiceConfig) (*string, error) {
	ret := _m.Called(projectName, config)

	var r0 *string
	if rf, ok := ret.Get(0).(func(string, *api.ObservationServiceConfig) *string); ok {
...
func (_m *ObservationService) UpdateService(projectName string, observationServiceID int, config *api.ObservationServiceConfig) (*string, error) {
	ret := _m.Called(projectName, observationServiceID, config)

	var r0 *string
	if rf, ok := ret.Get(0).(func(string, int, *api.ObservationServiceConfig) *string); ok {
