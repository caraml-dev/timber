...
import (
	...
	models "github.com/caraml-dev/timber/dataset-service/models"
)
...
func (_m *ObservationService) CreateService(projectName string, config *api.ObservationServiceConfig) (*models.ObservationServiceResponse, error) {
	ret := _m.Called(projectName, config)

	var r0 *models.ObservationServiceResponse
	if rf, ok := ret.Get(0).(func(string, *api.ObservationServiceConfig) *models.ObservationServiceResponse); ok {
		r0 = rf(projectName, config)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.ObservationServiceResponse)
		}
	}
...
func (_m *ObservationService) UpdateService(projectName string, observationServiceID int, config *api.ObservationServiceConfig) (*models.ObservationServiceResponse, error) {
	ret := _m.Called(projectName, observationServiceID, config)

	var r0 *models.ObservationServiceResponse
	if rf, ok := ret.Get(0).(func(string, int, *api.ObservationServiceConfig) *models.ObservationServiceResponse); ok {
