...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DatasetServiceApi()
        api_instance.dataset_service_create_log_writer  # this is an instance of the class Endpoint
        api_instance.dataset_service_create_log_writer()  # this invokes api_instance.dataset_service_create_log_writer.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.dataset_service_create_log_writer.callable or self.callable in this class
